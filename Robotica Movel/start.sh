...
pre_input="export UAV_NAME=uav1; export RUN_TYPE=simulation; export UAV_TYPE=f450; export WORLD_NAME=simulation; export SENSORS='garmin_down'; export WORLD_FILE=./world.yaml; export PX4_SIM_SPEED_FACTOR=2.0"
...
input=(
  'Roscore' "roscore
"
  'Gazebo' "waitForRos; roslaunch petrobras_challenge simulation_arena.launch world_name:=fase1 gui:=true
"
  'Spawn' 'waitForSimulation; rosservice call /mrs_drone_spawner/spawn "1 --pos 7 7 0 0 $UAV_TYPE --enable-rangefinder --enable-velodyne --use-gpu-ray --enable-ground-truth --enable-bluefox-camera --enable-realsense-front"
'
  'Control' "waitForOdometry; roslaunch mrs_uav_general core.launch config_uav_manager:=./custom_configs/uav_manager.yaml
"
  'Battery' "waitForControl; roslaunch battery_simulator p3dx.launch
"
